...
export default function CommentItem({ comment }: { comment: Comment }) {
    ...
    const deleteComment = () => {
        form.delete(route('comment.destroy', comment.id), { preserveScroll: true, preserveState: true });
    };
    return (
        <div className="mb-3 flex items-center gap-4 rounded-full hover:bg-gray-700">
